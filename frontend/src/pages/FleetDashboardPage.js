  ...
  return (
    <div data-testid="fleet-dashboard" className="space-y-4">
      <h1 className="font-heading text-2xl font-bold flex items-center gap-3" style={{ color: '#F0F4FF' }}>
        <Users size={24} style={{ color: '#EC4899' }} /> Fleet Simulator<InfoTip label="Fleet Simulator" description="A safe way to pretend you have dozens or hundreds of slot machines talking to another system. Use it to load-test a host, rehearse a migration, or generate realistic traffic without touching the real floor." />
      </h1>
